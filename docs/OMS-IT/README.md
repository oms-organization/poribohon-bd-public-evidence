# OMS IT — Public Documentation & Relationship Surface

**Official website:** https://omsitbd.com/

This directory is a **public structural/evidence surface** for OMS IT. It intentionally mirrors the high-level categories of the private OMS IT engineering workspace without copying private source code, private notes, credentials, logs, internal infrastructure details, confidential project records, or other non-public data.
...
- [Engineering & Operations](ENGINEERING.md)

### Projects & relationships
- [Projects](PROJECTS.md)
- [Public Relationship Map](RELATIONSHIPS.md)
...
The private repository remains the engineering source of truth. This public surface contains only safe, intentionally published summaries and references. A matching section name does not imply that its private contents are exposed here.
